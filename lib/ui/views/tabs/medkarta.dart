                  ...
                  children: [
                              ...
                              case 'В клинике':
                                return HistoryCard(
                                  ...
                                  subtitle: medkartaHistory[index]
                                      ['speciality'],
                                  trailing: medkartaHistory[index]['date'],
                                );
                              case 'На дому':
                                return HistoryCard(
                                  colors: const [
                    ...
                    if (_value == 1)
                      ListView.builder(
                          ...
                          itemBuilder: (ctx, index) {
                            switch (medkartKonsultation[index]['location']) {
                              case 'В клинике':
                                return HistoryCard(
                                  colors: const [
                                    Color(0xFF39B4F9),
                                  ...
                                  badgeLabel: medkartKonsultation[index]
                                      ['location'],
                                  title: medkartKonsultation[index]['name'],
                                  subtitle: medkartKonsultation[index]
                                      ['speciality'],
                                  trailing: medkartKonsultation[index]['date'],
                                );
                              case 'На дому':
                                return HistoryCard(
                                  colors: const [
