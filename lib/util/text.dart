...
const List<String> phrases = [
  'Добрый день, опишите пожалуйста свои симптомы',
  'Что еще ощущаете?',
  'Передайте пожалуйста свои контактные данные',
  'Ваши данные переданы, будьте на связи, с вами свяжется скорая служба.',
];
